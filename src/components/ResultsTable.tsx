                ...
                filteredChannels.map(c => {
                  ...
                  <tr key={c.channel_id} className="hover:bg-slate-50/70 dark:hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      ...
                      {c.discord_candidate_locator && !c.discord_invite && c.discord_liveness_status !== 'ACTIVE' && <div className="mt-0.5 max-w-48 truncate font-mono text-[10px] text-slate-500" title={c.discord_candidate_locator}>Discovered candidate: {c.discord_candidate_locator.replace('https://','')}</div>}

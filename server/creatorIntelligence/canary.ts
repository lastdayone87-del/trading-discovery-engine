...
export interface CreatorCanaryAssignment {
  ...
  actionType: typeof CREATOR_SEARCH_CANARY_ACTION_TYPE;
  rolloutBasisPoints: number;
...
export function decideCreatorCanaryArm(input: {
  ...
  const common = {
    opportunityKey: input.opportunityKey, country: input.country, actionType: CREATOR_SEARCH_CANARY_ACTION_TYPE,

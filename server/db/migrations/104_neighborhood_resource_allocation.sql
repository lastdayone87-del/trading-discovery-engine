...
ALTER TABLE frontier_allocation_decisions
  ...
  DROP CONSTRAINT IF EXISTS chk_frontier_alloc_quota_consumed_lte_reserved;

ALTER TABLE frontier_allocation_decisions
  ADD CONSTRAINT chk_frontier_alloc_quota_reserved CHECK (quota_reserved BETWEEN 1 AND 100),
  ADD CONSTRAINT chk_frontier_alloc_quota_consumed CHECK (quota_consumed >= 0),
  ADD CONSTRAINT chk_frontier_alloc_quota_consumed_lte_reserved CHECK (quota_consumed <= quota_reserved);
